...
> 全局纪律见根 [AGENTS.md](../AGENTS.md)「文档纪律」（单源/写当前状态/相对链接/字数预算）——本件不重抄。方法论文档纪律单源：[doc-standards.md](method/doc-standards.md)（tier 表）；流程/踩坑单源：[cookbook.md](cookbook.md)。本件只写本目录独有的具体失败。
