...
- [ ] （A）批次表（46 项）开工中：**批次 7 开工**（序 34 一行安装、序 35 多 harness 第一刀〔Hermes〕、序 36 胶囊组合裁决均落，[ADR](.agents/notes/implemented/architecture/2026-09-14-capsule-composition-verdict.md)）；游标 = **批次 7 序 37**（插件市场 / capability manifest 适配）。单源 = [批次表 ADR](.agents/notes/proposed/architecture/2026-09-13-feature-completion-backlog.md)。
