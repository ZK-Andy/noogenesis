...
- [ ] （A）批次表（46 项）开工中：**批次 5 可办拍板面已落**（开题轮：序 23/24 维持后置、28 确认全覆盖、29 归属本仓插件、25/27 确认落账——[开题轮 ADR](.agents/notes/implemented/architecture/2026-09-14-batch5-opening-round.md)），余 21/22/26 保留位；游标 = **批次 6（P3 元演化，序 30–33）**：首件序 30 须先重拍 P1 D3。单源 = [批次表 ADR](.agents/notes/proposed/architecture/2026-09-13-feature-completion-backlog.md)。
