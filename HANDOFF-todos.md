...
- [ ] （D）架构规范实现批（立项已收 2026-09-10，charter ADR [2026-09-10-architecture-standards-charter](.agents/notes/proposed/architecture/2026-09-10-architecture-standards-charter.md) proposed）：按 charter 写正文 + manifest 条目 + code-standards §4 改指，FULL 三审后翻 implemented；与上帝类闸（C15）合流。
