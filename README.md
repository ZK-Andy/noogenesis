...
├── adapters/dsh/           # DSH adapter layer (plugin shell wiring: system-prompt section / noo_* tools / solidify confirmation / geneBankUrl lazy pull / bank-distributed skills / four-point mount wiring A2–A5 with the A2 opening map (A6/A8 record projection removed, see the removal ADR); TS source since B2, npm package = tsc dist)
