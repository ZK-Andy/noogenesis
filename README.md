...
├── adapters/dsh/           # DSH adapter layer (plugin shell wiring: system-prompt section / noo_* tools / solidify confirmation / geneBankUrl lazy pull / bank-distributed skills / six-point mount wiring A2–A6+A8 with M1–M3 record policies; TS source since B2, npm package = tsc dist)
