...
- 2026-09-10｜**M1 双方案设计轮拍板（讨论轮；实现批待开）**：守卫 = 三件套 v0（阻断档判不立）+ 防过度 = 混合 D（cases 留辩论）；立项 ADR [2026-09-10-m1-guard-anti-overdesign](.agents/notes/proposed/architecture/2026-09-10-m1-guard-anti-overdesign.md) proposed（`b16097e`→收尾批）；要点在优化轮 §2.2-1/2。README 无漂移。
