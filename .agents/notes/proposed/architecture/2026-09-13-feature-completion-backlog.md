...
- **未交付**：下方批次表余 7 项（序 1–20、23–25、27–42 已落终态，游标 = 序 43；序 21/22/26 为前提/策展保留位）。
