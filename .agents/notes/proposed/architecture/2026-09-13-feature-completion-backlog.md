...
- **未交付**：下方批次表余 9 项（序 1–20、23–25、27–40 已落终态，游标 = 序 41；序 21/22/26 为前提/策展保留位）。
