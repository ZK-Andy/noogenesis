...
- **未交付**：下方批次表余 19 项（序 1–20 与序 23/24/25/27/28/29/30 已落终态，游标 = 批次 6 余序 31–33；序 21/22/26 为前提/策展保留位）。
