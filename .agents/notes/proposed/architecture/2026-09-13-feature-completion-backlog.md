...
- **未交付**：下方批次表余 14 项（序 1–20 与序 23–25、27–35 已落终态，游标 = 批次 7 序 36；序 21/22/26 为前提/策展保留位）。
