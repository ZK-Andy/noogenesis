...
来源项目（desktop / frecency）把会话叙事、评审简报、规划文档全部 gitignore：换机器即丢全部过程资产，可复现性只能靠"复述进 durable 家"的人工纪律兜底。心源的立场相反：过程即资产——会话轨迹是未来蜂群演化的原料（主设计 §2.3 时间维度：DSH 把经验记成可回放、可分叉的事件流），丢叙事等于丢基因。
